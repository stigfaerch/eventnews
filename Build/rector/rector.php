...
return RectorConfig::configure()
    ...
    ->withConfiguredRule(ExtEmConfRector::class, [
        ...
        ExtEmConfRector::TYPO3_VERSION_CONSTRAINT => '13.4.29-14.3.99',
        ExtEmConfRector::ADDITIONAL_VALUES_TO_BE_REMOVED => [],
    ])
    ->withSkip([
        // EXT:news merges this class body into GeorgRinger\News\Domain\Model\News
        // via its ClassCacheManager. In the generated file every unqualified name
        // resolves against the news namespace, so Rector must not shorten the
        // fully qualified class names in here.
