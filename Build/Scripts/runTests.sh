...
Examples:
    ...
    ./Build/Scripts/runTests.sh -s functional -- --filter 'tcaIsLoaded' Tests/Functional/Tca/TcaTest.php

    # Run functional tests on postgres with xdebug, php 8.1 and execute a restricted set of tests
    ./Build/Scripts/runTests.sh -x -p 8.2 -s functional -d postgres -- Tests/Functional/Tca/TcaTest.php
